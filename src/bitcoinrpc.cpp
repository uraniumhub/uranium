...
{
    return GetBoolArg("-testnet", false) ? 22182 : 32182;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Uranium server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: uranium-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use uraniumd";
