...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Uranium " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"uraniumtools.com", "34.238.34.137"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"uraniumtools.com", "testnet-seed.uraniumtools.com"},
    {"xurious.com", "testnet-seed.ura.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Uranium is probably already running."), addrBind.ToString().c_str());
        else
